...
#ifdef HDFDATA
      IsHDF=.false.
	call HDF1_CheckifHDF(iout1)
      if(ibd.eq.1.and.IsHDF)then
          call HDF1WriteCBB(iout1, kKSTP, kKPER,10)
      else
...
#ifdef HDFDATA
      IsHDF=.false.
	call HDF1_CheckifHDF(iout2)
      if(ibdst.eq.1.and.IsHDF)then
          call HDF1WriteCBB(iout2,kkstp,kkper,11)
      else
