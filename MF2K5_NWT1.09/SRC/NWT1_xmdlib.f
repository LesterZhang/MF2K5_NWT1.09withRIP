...
c
   ...
   20 continue
     ...
     [                    nred, n, nja, njaf, nitmax, north, ierr,FTOL)
...
c     deallocate( q, qb, aqb, reso, res, t, s, sb )
     ...
     [                    ctol, rrctol, 
     [                    ia, ja, iaf, jaf, idiagf, RBorder, nblack,
     [                    nred, n, nja, njaf, nitmax, ierr,ftol)
...
c
     ...
     [                   nja, n, north, nitmax, iacl, ierr,ftol)
      ...
      double precision :: a(nja), b(n), x(n), ctol, rrctol,ftol
c
c     local variables
c
